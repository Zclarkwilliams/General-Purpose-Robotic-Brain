...
class NeuralModel {
    public:
		...
		*/
		...
		void transferNeurons(struct NeuralModel::Organisms*);
		void transferNonSpikingSynapses(struct NeuralModel::Organisms*);
		void transferConnexions(struct NeuralModel::Organisms*);
};